...
export class OlMap {
  ...
  private _createLayers() {
    ...
    const beschermdWmsLayer = new ol.layer.Tile({
    ...
    beschermdWmsLayer.set('title', 'Beschermd Onroerend Erfgoed');
    beschermdWmsLayer.set('type', 'overlay');
    this.map.addLayer(beschermdWmsLayer);
