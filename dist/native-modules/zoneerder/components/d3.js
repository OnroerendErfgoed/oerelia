...
export function setupD3(container, data, relevanteAfstanden, setRelevanteAfstandFn) {
    if (!container) {
        return;
    }
    container.innerHTML = '';
...
export function drawNewCircle(targetX, data, isPredictionMarker, setRelevanteAfstandFn) {
